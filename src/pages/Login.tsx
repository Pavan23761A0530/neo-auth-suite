      ...
      <div className="w-full max-w-md">
        ...
        <div className="glass-card animate-slide-in-up">
          <div className="text-center mb-8">
            ...
            <p className="text-muted-foreground">Sign in to your Pavan Marketing account</p>
          </div>
          ...
          <div className="space-y-3">
            <button className="w-full flex items-center justify-center space-x-3 px-6 py-3 border border-border rounded-xl hover:bg-muted/50 transition-colors">
